...
<body>
    ...
    <?php
        ...
        $show_all_credit=[];
        $sql = "SELECT lname,begin_date,introduction,place,lid,end_date from lessons WHERE type=1 ORDER by begin_date DESC";
        ...
        <table style="border:3px #cccccc solid;" cellpadding="10" border='1'>
            <?php
                ...
                else
                {
                    ...
                    echo "<td class='col-1' style='text-align: center;'>課程開始時間</td>";
                    echo "<td class='col-1' style='text-align: center;'>課程結束時間</td>";
                    ...
                    for ($i = 0; $i<count($show_all_credit); $i++)
                    {
                        ...
                        echo "<td class='col-1' style='text-align: center;'>".$show_all_credit[$i][5]."</td>";
                        ...
                        echo "<td class='col-1' style='text-align: center;'>"."<a href=\"signup.php?lid=".$show_all_credit[$i][4].
                        "&begin_date=".$show_all_credit[$i][1]."&end_date=".$show_all_credit[$i][5]."\"style=\"text-decoration:none\">報名</a>"."</td>";
                        echo "</tr>";
                    }
                }
            ?>
