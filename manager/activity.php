...
<body>
    ...
    <?php
        ...
        $show_all_activity=[];
        $sql = "SELECT lname,begin_date,introduction,place,lid,type from lessons WHERE type=0 ORDER by begin_date DESC";
        ...
        <table style="border:3px #cccccc solid;" cellpadding="10" border='1'>
            ...
            else
            {
                ...
                for ($i = 0; $i<count($show_all_activity); $i++)
                {
                    ...
                    echo "<td class='col-1' style='text-align: center;border:1px #cccccc solid;'>"."<a href=\"signin.php?lid=".$show_all_activity[$i][4]
                        ."&type=".$show_all_activity[$i][5]."\"style=\"text-decoration:none\">簽到狀況</a>"."</td>";
                    echo "<td class='col-1' style='text-align: center;border:1px #cccccc solid;'>"."<a href=\"multiemail.php?lid=".$show_all_activity[$i][4]
                        ."&type=".$show_all_activity[$i][5]."\"target=\"_blank"."\"style=\"text-decoration:none\">寄信</a>"."</td>";
                    ...
                    echo "<td class='col-1' style='text-align: center;border:1px #cccccc solid;'><a href=./unsignact.php?var=".$show_all_activity[$i][4]." style='text-decoration:none;'    id='disableLink'>結束點名</a></td>";
                    echo "</tr>";
