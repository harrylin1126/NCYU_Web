...
<body>
    <?php
        if (isset($_POST["Insert"])) 
        {
            ...
            {
                header("Location: AddActivity.php?error=活動名稱不得為空");
                exit();
            }
            elseif (empty($activityIntroduction))
            {
                header("Location: AddActivity.php?error=活動介紹不得為空");
                exit();
            }
            elseif (empty($beginTime))
            {
                header("Location: AddActivity.php?error=活動開始時間不得為空");
                exit();
            }
            elseif (empty($endTime))
            {
                header("Location: AddActivity.php?error=活動結束時間不得為空");
                exit();
            }
            elseif (empty($activityLocation))
            {
                header("Location: AddActivity.php?error=活動地點不得為空");
                exit();
            }
            else
            {   
